...
if ($conn->query($sql2) === TRUE && $conn->query($sql3)===TRUE && $conn->query($sql5)===TRUE && $conn->query($sql6)===TRUE && $conn->query($sql4)===TRUE) {

   $arr = array('error'=>" no error",'result'=>"success","message"=>"Mukiriya Mwiza,Ubikuje Neza kuri konte yawe");
