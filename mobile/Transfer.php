...
//$sql6="insert into message(accno,Content,doneDate,messageId)values('$senderAccount','$messagreceiver','$doneDate','$j')";
...
$arr = array('error'=> "error",'result' =>"failed","message"=>"Kohereza ntibikunze!!!!");
   echo json_encode($arr);
    ...
    $arr = array('error'=> "error",'result' =>"failed","message"=>"Konti ntzibaho");
   echo json_encode($arr);
    }
