...
if($conn->query($sql5)===TRUE && $conn->query($sql6)===TRUE && $conn->query($sql4)===TRUE) {
   ...
   if($conn->query($sql2) === TRUE && $conn->query($sql3)===TRUE){
      ...
      $arr = array('error'=>" no error",'result'=>"success","message"=>"Kubitsa Byagenze Neza");
   ...
   $arr = array('error'=>"error",'result'=>"failed","message"=>"Kubitsa Ntibikunze,Mwongere mugerageze");
