...
$messagecontent="Wohereje amafaranga:".$amount."Avuye Kuri Konti yawe:".$senderAccount."Ajya kuri Konti ".$accoudestination."Murakoze!!!";


$messagreceiver="wakiriye amafaranga:".$amount."Avuye kuri Konti:".$senderAccount."  Impamvu:
".$comments."     Murakoze!!!";
...
$sql4="insert into transaction(transId,Main_account,doneDate,amount,type,accountDest,comments)values
      ('$transId','$senderAccount','$doneDate','$amount','$type','$accoudestination','$comments')";
...
$arr = array('error'=> "error",'result' =>"failed","message"=>"Kohereza ntibikunze,Ongera Ugerageze!!!!");
   echo json_encode($arr);
    ...
    $arr = array('error'=> "error",'result' =>"failed","message"=>"Transfer yanze");
   echo json_encode($arr);
    }
