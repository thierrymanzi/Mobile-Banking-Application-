...
//	}
	...
	public class WithdrawAsyncTask extends AsyncTask<String, Void, String> {

		@Override
		protected void onPreExecute() {
			super.onPreExecute();
			pd.setTitle("WITHDRAW MONEY");
...
//							+ resultat.getMessage(), Toast.LENGTH_SHORT).show();
			...
			LayoutInflater li = LayoutInflater.from(WithdrawActivity.this);
			View promptsView;
