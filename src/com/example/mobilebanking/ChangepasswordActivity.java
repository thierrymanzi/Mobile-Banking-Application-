...
//			$newpassword= $_PSOT['newpassword'];
//			$repeat_newpassword=$_POST['repeat_newpassword'];
//			
			String sendString = "http://192.168.250.1/mobile/Changepassword.php?accountNumber=" 
					+accountNumber 
					+"&oldpassword=" 
					+oldpin
					+"&newpassword="
...
//							+ resultat.getMessage(), Toast.LENGTH_SHORT).show();
			...
			LayoutInflater li = LayoutInflater.from(ChangepasswordActivity.this);
			View promptsView;
