...
public class BuyUmuriroActivity extends Activity {
...
ProgressDialog pd;
 ...
 String[] celebrities = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.umuriro_activity);
        intes=getIntent();
...
//	}
	...
	public void ElectricityClick(View v) {
		new ElectricityAsyncTask().execute();
	}

	public class ElectricityAsyncTask extends AsyncTask<String, Void, String> {

		@Override
		protected void onPreExecute() {
			super.onPreExecute();
			pd.setTitle("KUGURA UMURIRO");
...
//                    +pin;
      ...
      try {
      stringUrl = "http://192.168.250.1/mobile/buyumuriro.php?senderAccount="
...
//							+ resultat.getMessage(), Toast.LENGTH_SHORT).show();
			...
			LayoutInflater li = LayoutInflater.from(BuyUmuriroActivity.this);
			View promptsView;
